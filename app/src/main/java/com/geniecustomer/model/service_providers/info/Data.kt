...
data class Data(
    ...
    val ratingList: List<ReviewItem?>? = null,
    ...
    @field:SerializedName("timeSlotList")
    val timeSlotList: List<TimeSlotListItem?>? = null,
    ...
    @field:SerializedName("otherServiceList")
    val otherServices: ArrayList<OtherServices> = ArrayList()
