...
class GenerateInvoiceViewModel(var repository: Repository) : ViewModel(){
    ...
    fun generateInvoice(token:String,jsonObject: RequestBody){
        disposables.add(
            repository.generateInvoice(token,jsonObject)
