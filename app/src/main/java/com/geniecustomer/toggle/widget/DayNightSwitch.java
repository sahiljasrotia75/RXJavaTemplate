...
package com.geniecustomer.toggle.widget;
...
import com.geniecustomer.toggle.model.ToggleableView;
...
public class DayNightSwitch extends ToggleableView {
    ...
    private final int stars = Color.parseColor("#FCFCFC");
    private final int sunInner = Color.parseColor("#F5EB42");
    private final int sunOuter = Color.parseColor("#E4C74D");
    private final int moonInner = Color.parseColor("#FFFDF2");
    private final int moonOuter = Color.parseColor("#DEE1C5");
    private final int cloudInner = Color.parseColor("#FFFFFF");
    private final int cloudOuter = Color.parseColor("#D4D4D2");
    private final int craterInner = Color.parseColor("#EFEEDA");
    private final int parentOuter = Color.parseColor("#81C0D5");
    private final int parentInner = Color.parseColor("#C0E6F6");
    private final int parentDarkOuter = Color.parseColor("#202020");
    private final int parentDarkInner = Color.parseColor("#484848");
